...
The idea that “structure follows strategy” is well established, thanks to thinkers like Jay Galbraith and Alfred Chandler. But in practice, it is often misunderstood—or selectively applied.

To apply it with rigour, leaders must commit to this sequence:
...
When structures are shaped to fit individual leaders, rather than business priorities, a number of predictable challenges arise:

* **Redundant roles and unclear accountability:** Roles are created to ‘fit people in’ rather than solve for clear needs, leading to duplication and blurred ownership.
* **Inefficient spans and uneven workloads:** Some leaders end up stretched thin while others operate in silos, often because comfort or loyalty dictated structure.
* **Decision gridlock and turf conflict:** Overlapping mandates and vague boundaries create friction, slowing down execution and diffusing responsibility.
* **Development bottlenecks:** Leaders are placed into roles without adequate support or challenge, assuming past success translates into future fit.

Designing around individuals may seem like a people-first approach. In reality, it often undermines both individual effectiveness and enterprise performance.

### Leadership Fit Must Be Intentional

Of course, structure alone doesn’t deliver results—people do. But that’s precisely why matching leadership to the demands of the model is essential.

This doesn’t mean removing people. It means deploying them with intent, based on the capabilities and mindset needed to succeed in the new design.

Leaders must ask:
* Does this person have the adaptability, systems thinking, and collaboration skills this model requires?
* Are they prepared to lead across boundaries—not just within a silo?
* What development or coaching might help them grow into the role, rather than around it?

Just because someone thrived under the old model doesn’t guarantee they will excel in the new one. Every design shift is also a leadership shift.
...
When strategy, structure, and leadership are synchronized, teams operate with greater clarity, energy, and direction. Strategic outcomes are no longer aspirational—they become achievable and sustainable.
...
The critical question is not “Where should this person go?”
