...
Too often, org design is treated as a temporary remedy—cutting cost, supporting a new strategy, or refreshing a function. But once the structure is launched, leadership attention moves elsewhere.

What happens next is predictable:
* Old habits reappear
* Decision rights blur
* New layers get added to old processes
* Matrix tensions resurface
* And after 12–18 months, complexity returns—sometimes worse than before

This happens when redesign is approached as a project, not as a leadership discipline.
...
* What should be centralised vs. owned close to the customer
...
* Adjusted routines and governance so meetings, decisions, and workflows reflect the new design

Galbraith’s Star Model remains a powerful reminder: structure is only one lever. Process, people systems, culture, and rewards must all align if the design is to take root.

### Adapt Without Undoing the Model
...
* A lens to diagnose execution issues
